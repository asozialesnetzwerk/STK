...
in vec3 varposition;
const float cons5 = float(0.030000);
const float cons9 = float(1.500000);
in vec3 varnormal;
uniform mat4 unfinvviewmat;
in vec3 var0;
in vec2 var1;
in vec4 var2;
const mat4 cons27 = mat4(3.000000, 0.000000, 0.000000, 0.000000, 0.000000, 3.000000, 0.000000, 0.000000, 0.000000, 0.000000, 3.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000);
const vec3 cons28 = vec3(0.000000, 0.000000, 0.000000);
const vec3 cons29 = vec3(1.000000, 1.000000, 1.000000);
const float cons30 = float(0.000000);
const float cons31 = float(0.000000);
uniform sampler2D samp0;
uniform sampler2D samp1;
const mat4 cons48 = mat4(0.500000, 0.000000, 0.000000, 0.000000, 0.000000, 0.500000, 0.000000, 0.000000, 0.000000, 0.000000, 0.500000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000);
const vec3 cons49 = vec3(0.000000, 0.000000, 0.000000);
const vec3 cons50 = vec3(0.500000, 1.000000, 1.000000);
const float cons51 = float(0.000000);
const float cons52 = float(0.000000);
uniform sampler2D samp2;
const float cons68 = float(0.250000);
const float cons72 = float(1.200000);
const mat4 cons75 = mat4(64.000000, 0.000000, 0.000000, 0.000000, 0.000000, 64.000000, 0.000000, 0.000000, 0.000000, 0.000000, 64.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000);
const vec3 cons76 = vec3(0.000000, 0.000000, 0.000000);
const vec3 cons77 = vec3(1.000000, 1.000000, 1.000000);
const float cons78 = float(0.000000);
const float cons79 = float(0.000000);
uniform sampler2D samp3;
const vec4 cons90 = vec4(0.501172, 0.501172, 0.501172, 0.000000);
const float cons92 = float(0.000000);
const float cons96 = float(18.109999);
in vec2 var3;
const mat4 cons115 = mat4(3.000000, 0.000000, 0.000000, 0.000000, 0.000000, 3.000000, 0.000000, 0.000000, 0.000000, 0.000000, 3.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000);
const vec3 cons116 = vec3(0.000000, 0.000000, 0.000000);
const vec3 cons117 = vec3(1.000000, 1.000000, 1.000000);
const float cons118 = float(0.000000);
const float cons119 = float(0.000000);
uniform sampler2D samp4;
const vec4 cons134 = vec4(0.011144, 0.011144, 0.011144, 1.000000);
const mat4 cons137 = mat4(8.000000, 0.000000, 0.000000, 0.000000, 0.000000, 8.000000, 0.000000, 0.000000, 0.000000, 0.000000, 8.000000, 0.000000, 1.500000, 0.000000, 0.000000, 1.000000);
const vec3 cons138 = vec3(0.000000, 0.000000, 0.000000);
const vec3 cons139 = vec3(4.000000, 1.000000, 1.000000);
const float cons140 = float(0.000000);
const float cons141 = float(0.000000);
const mat4 cons155 = mat4(6.000000, 0.000000, 0.000000, 0.000000, 0.000000, 6.000000, 0.000000, 0.000000, 0.000000, 0.000000, 6.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000);
const vec3 cons156 = vec3(0.000000, 0.000000, 0.000000);
const vec3 cons157 = vec3(1.000000, 1.000000, 1.000000);
const float cons158 = float(0.000000);
const float cons159 = float(0.000000);
const mat4 cons173 = mat4(7.000000, 0.000000, 0.000000, 0.000000, 0.000000, 7.000000, 0.000000, 0.000000, 0.000000, 0.000000, 7.000000, 0.000000, 0.500000, 0.000000, 0.000000, 1.000000);
const vec3 cons174 = vec3(0.000000, 0.000000, 0.000000);
const vec3 cons175 = vec3(1.000000, 1.000000, 1.000000);
const float cons176 = float(0.000000);
const float cons177 = float(0.000000);
const float cons190 = float(0.794550);
const float cons194 = float(0.923706);
const vec4 cons200 = vec4(0.011144, 0.011144, 0.011144, 1.000000);
const vec4 cons219 = vec4(0.009141, 0.010259, 0.010882, 1.000000);
const vec4 cons223 = vec4(1.000000, 0.369167, 0.019324, 1.000000);
const float cons225 = float(1.000000);
const float cons229 = float(2.000000);
const vec4 cons231 = vec4(0.500000, 0.500000, 0.500000, 1.000000);
uniform vec3 unf240;
uniform float unf249;
uniform float unf251;
uniform vec3 unf252;
const float cons257 = float(1.000000);
const vec4 cons261 = vec4(1.000000, 1.000000, 1.000000, 0.005000);
uniform float unf272;
uniform float unf275;
uniform vec3 unf281;
uniform vec3 unf286;
uniform float unf297;
uniform float unf299;
uniform vec3 unf300;
const float cons305 = float(1.000000);
const vec4 cons309 = vec4(1.000000, 1.000000, 1.000000, 0.005000);
const float cons318 = float(0.500000);
uniform float unf319;
uniform vec3 unf324;
const float cons334 = float(1.000000);
uniform vec4 unf335;
uniform vec3 unf337;
const float cons345 = float(1.000000);
uniform float unf348;
uniform float unf349;
uniform float unf350;
uniform float unf351;
uniform float unf352;
uniform vec4 unf356;
const float cons365 = float(1.000000);
const float cons368 = float(1.000000);
...
void main()
{
	...
	camera(varposition, tmp2, tmp3, tmp4);
	math_multiply(cons5, tmp4, tmp7);
	math_pow(tmp7, cons9, tmp10);
	geom(varposition, facingnormal, unfinvviewmat, var0, var1, var2, tmp17, tmp18, tmp19, tmp20, tmp21, tmp22, tmp23, tmp24, tmp25);
	mapping(tmp21, cons27, cons28, cons29, cons30, cons31, tmp32);
	texture_image(tmp32, samp0, tmp35, tmp36, tmp37);
	srgb_to_linearrgb(tmp36, tmp39);
	texture_image(tmp32, samp1, tmp42, tmp43, tmp44);
	srgb_to_linearrgb(tmp43, tmp46);
	mapping(tmp21, cons48, cons49, cons50, cons51, cons52, tmp53);
	texture_image(tmp53, samp2, tmp56, tmp57, tmp58);
	srgb_to_linearrgb(tmp57, tmp60);
	texture_image(tmp21, samp2, tmp63, tmp64, tmp65);
	srgb_to_linearrgb(tmp64, tmp67);
	math_multiply(cons68, tmp4, tmp70);
	math_pow(tmp70, cons72, tmp73);
	mapping(tmp21, cons75, cons76, cons77, cons78, cons79, tmp80);
	texture_image(tmp80, samp3, tmp83, tmp84, tmp85);
	srgb_to_linearrgb(tmp84, tmp87);
	mix_blend(tmp73, tmp87, cons90, tmp91);
	mix_burn(cons92, tmp67, tmp60, tmp95);
	math_multiply(cons96, convert_rgba_to_float(tmp95), tmp98);
	geom(varposition, facingnormal, unfinvviewmat, var0, var3, var2, tmp105, tmp106, tmp107, tmp108, tmp109, tmp110, tmp111, tmp112, tmp113);
	mapping(tmp109, cons115, cons116, cons117, cons118, cons119, tmp120);
	texture_image(tmp120, samp4, tmp123, tmp124, tmp125);
	srgb_to_linearrgb(tmp124, tmp127);
	separate_rgb(tmp127, tmp129, tmp130, tmp131);
	mix_burn(tmp98, vec4(tmp129, tmp129, tmp129, 1.0), cons134, tmp135);
	mapping(tmp21, cons137, cons138, cons139, cons140, cons141, tmp142);
	texture_image(tmp142, samp4, tmp145, tmp146, tmp147);
	srgb_to_linearrgb(tmp146, tmp149);
	separate_rgb(tmp149, tmp151, tmp152, tmp153);
	mapping(tmp21, cons155, cons156, cons157, cons158, cons159, tmp160);
	texture_image(tmp160, samp4, tmp163, tmp164, tmp165);
	srgb_to_linearrgb(tmp164, tmp167);
	separate_rgb(tmp167, tmp169, tmp170, tmp171);
	mapping(tmp21, cons173, cons174, cons175, cons176, cons177, tmp178);
	texture_image(tmp178, samp4, tmp181, tmp182, tmp183);
	srgb_to_linearrgb(tmp182, tmp185);
	separate_rgb(tmp185, tmp187, tmp188, tmp189);
	mix_add(cons190, vec4(tmp170, tmp170, tmp170, 1.0), vec4(tmp152, tmp152, tmp152, 1.0), tmp193);
	mix_add(cons194, vec4(tmp188, tmp188, tmp188, 1.0), tmp193, tmp197);
	mix_burn(tmp98, tmp197, cons200, tmp201);
	texture_image(tmp21, samp0, tmp204, tmp205, tmp206);
	srgb_to_linearrgb(tmp205, tmp208);
	mix_blend(convert_rgba_to_float(tmp95), tmp39, tmp46, tmp212);
	mix_blend(tmp10, tmp212, tmp208, tmp216);
	mix_blend(convert_rgba_to_float(tmp201), tmp216, cons219, tmp220);
	mix_blend(convert_rgba_to_float(tmp135), tmp220, cons223, tmp224);
	mix_mult(cons225, tmp91, tmp224, tmp228);
	mix_div(cons229, tmp228, cons231, tmp232);
	set_rgba_zero(tmp233);
	shade_norm(facingnormal, tmp235);
	shade_view(varposition, tmp237);
	set_rgb_zero(tmp238);
	set_rgb_zero(tmp239);
	lamp_visibility_sun_hemi(unf240, tmp241, tmp242, tmp243);
	shade_inp(tmp235, tmp241, tmp246);
	shade_visifac(tmp246, tmp243, unf249, tmp250);
	shade_mul_value_v3(unf251, unf252, tmp253);
	shade_mul_value(tmp250, vec4(tmp253, 1.0), tmp256);
	mtex_value_invert(cons257, tmp258);
	mix_mult(tmp258, tmp256, cons261, tmp262);
	mtex_value_invert(tmp258, tmp264);
	shade_madd(vec4(tmp238, 1.0), tmp262, tmp232, tmp268);
	shade_cooktorr_spec(tmp235, tmp241, tmp237, unf272, tmp273);
	shade_spec_t(tmp264, unf275, tmp243, tmp273, tmp278);
	shade_add_spec(tmp278, tmp253, unf281, tmp282);
	shade_add_clamped(vec4(tmp239, 1.0), vec4(tmp282, 1.0), tmp285);
	lamp_visibility_sun_hemi(unf286, tmp287, tmp288, tmp289);
	shade_inp(tmp235, tmp287, tmp292);
	shade_is_hemi(tmp292, tmp294);
	shade_visifac(tmp294, tmp289, unf297, tmp298);
	shade_mul_value_v3(unf299, unf300, tmp301);
	shade_mul_value(tmp298, vec4(tmp301, 1.0), tmp304);
	mtex_value_invert(cons305, tmp306);
	mix_mult(tmp306, tmp304, cons309, tmp310);
	shade_madd(tmp268, tmp310, tmp232, tmp314);
	shade_hemi_spec(tmp235, tmp287, tmp237, cons318, unf319, tmp289, tmp321);
	shade_add_spec(tmp321, tmp301, unf324, tmp325);
	shade_add_clamped(tmp285, vec4(tmp325, 1.0), tmp328);
	shade_clamp_positive(tmp328, tmp330);
	shade_clamp_positive(tmp314, tmp332);
	shade_maddf(tmp332, cons334, unf335, tmp336);
	shade_add_mirror(unf337, tmp233, tmp336.rgb, tmp340);
	shade_add(vec4(tmp340, 1.0), tmp330, tmp343);
	mtex_alpha_to_col(tmp343, cons345, tmp346);
	shade_mist_factor(varposition, unf348, unf349, unf350, unf351, unf352, tmp353);
	mix_blend(tmp353, tmp346, unf356, tmp357);
	shade_alpha_opaque(tmp357, tmp359);
	vec_math_sub(tmp359.rgb, tmp330.rgb, tmp362, tmp363);
	mtex_alpha_to_col(vec4(tmp362, 1.0), cons365, tmp366);
	output_node(tmp366, cons368, tmp369);
	linearrgb_to_srgb(tmp369, tmp371);
