...
#endif
in vec4 att2;
uniform int att2_info;
out vec4 var2;
#ifndef USE_OPENSUBDIV
in vec2 att3;
uniform int att3_info;
out vec2 var3;
#endif
...
#ifndef USE_OPENSUBDIV
	set_var_from_attr(att1, att1_info, var1);
#endif
	set_var_from_attr(att2, att2_info, var2);
#ifndef USE_OPENSUBDIV
	set_var_from_attr(att3, att3_info, var3);
#endif
}
