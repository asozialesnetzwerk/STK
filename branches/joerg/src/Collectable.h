//  $Id: Collectable.h 251 2005-08-19 20:51:56Z joh $
//
...
enum collectableType {COLLECT_NOTHING, 
		      ...
		      // do we really need COLLECT_MAX???
		      COLLECT_MAX};

const int COLLECT_LAST_MISSILE=COLLECT_HOMING_MISSILE;

class CollectableManager {
 protected:
  Material *icons[COLLECT_MAX];
 public:
  CollectableManager();
  Material *getIcon(int type) {return icons[type];}
};

class Collectable {
 protected:
  static CollectableManager *collectable_manager;
  Kart*                      kart;
